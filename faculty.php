			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					 ...
					 <li class="hvr-sweep-to-bottom"><a href="index.html" class="scroll">Home</a></li>

						<li class="hvr-sweep-to-bottom"><a href="login.html">Admin Login</a></li>
						<li class="hvr-sweep-to-bottom active"><a href="faculty.php" class="scroll">Faculty</a></li>
...
// Assuming 'invg' is a key in the $_POST array
$n = isset($_POST['invg']) ? $_POST['invg'] : '';

// Using prepared statement to prevent SQL injection
$q = "SELECT * FROM faculty WHERE INVIGILATOR_NAME = ?";
...
if ($q2) {
    ...
    if ($row) {
        echo "FACULTY NAME:  " . $n . "<br>";
        echo "ROOM ALLOTTED TO YOU:  " . $row['ROOM_NO'] . "<br>";
        echo "TIMING:  " . $row['TIMING'];
    } else {
        echo "No results found for faculty name: " . $n;
    }
} else {
