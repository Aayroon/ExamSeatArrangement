			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					 ...
					 <li class="hvr-sweep-to-bottom"><a href="index.html" class="scroll">About Project</a></li>
						...
						<li class="hvr-sweep-to-bottom active"><a href="sview.html" class="scroll">Student</a></li>
...
{ $q5="SELECT*FROM room$rm WHERE col$i=$r";
  ...
  if ($rowno && isset($rowno['Rows'])) {
	echo $rowno['Rows']; // line 133
